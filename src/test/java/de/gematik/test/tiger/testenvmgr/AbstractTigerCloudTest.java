...
/**
 * Helper test class providing methods to start the test env mgr with a given tiger yaml config file.
 */
    ...
    public void createTestEnvMgrSafelyAndExecute(String configurationFilePath,
        ...
        try {
            if (StringUtils.isEmpty(configurationFilePath)) {
                ...
                // The reset() is important to make sure the props tree is really reset between tests as TGC is a globally available
